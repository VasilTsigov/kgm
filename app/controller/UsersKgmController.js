...
Ext.define('iagKgmMob.controller.UsersKgmController', {
    ...
    onSearchByNameBtnTap: function(button, e, eOpts) {
        Ext.Viewport.setMasked({ xtype: 'loadmask', message: 'Моля, изчакайте ...', indicator:true});
        			...
        			store.load(
        			{
        				...
        				callback: function(records, operation, success) {
        					...
        					if(success)
        					{
                                ...
                                this.getNavigationviewbyname().push(myresult);
        						console.log('success');
        					}
        					else
        					{
                ...
                if(!this.myresult){
        			var myresult = Ext.create('iagKgmMob.view.UsersKgmDetailsView');
        		}
    },
        ...
        var fulname = record.get('Ime')+' '+record.get('Prezime')+' '+record.get('Familia');
        		...
        		store.load(
        		{
        			...
        			callback: function(records, operation, success) {
        				...
        				{
        					Ext.Viewport.setMasked(false);
        					Ext.Msg.alert('Събщение', 'Няма регистрирано такова лице.', Ext.emptyFn);
        					console.log('unsuccess');
                        }
        			},
        			scope: this
